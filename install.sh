...
for cmd in prd.md tasks.md autopilotagent.md autopilotagent:init.md analyze.md cancel.md stop.md; do
...
echo ""
echo "Agents supported: claude (or any claude-* profile), codex, opencode, cmd"
echo ""
echo "Usage:"
